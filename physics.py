...
class Dynamics(object):
    ...
    def find_collision(self, obj1, obj2, dt):
        ...
        bbox1 = (obj1.bb_min.addition(obj1.next_position), 
                 obj1.bb_max.addition(obj1.next_position))
        bbox2 = (obj1.bb_min.addition(obj1.next_position), 
                 obj1.bb_max.addition(obj1.next_position))

        collision = None
        if self.bbox_intersect(bbox1, bbox2):
